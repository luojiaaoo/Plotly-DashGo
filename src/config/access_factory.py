...
from dash_view.application.task_ import task_mgmt
...
class AccessFactory:
    ...
    views = [role_mgmt, user_mgmt, group_auth, group_mgmt, workbench, monitor, personal_info, announcement, task_mgmt, *apps]
    ...
    # 系统管理员默认权限
    admin_access_meta = ('用户管理-页面', '角色管理-页面', '团队管理-页面', '公告管理-页面', '任务管理-页面')

    # 内置可以分配的权限
    assignable_access_meta = ('任务管理-页面',)
