...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('super_admin', '[\"团队管理-页面\", \"角色管理-页面\", \"用户权限-页面\", \"团队权限-页面\", \"工作台-页面\", \"监控页-页面\", \"个人信息-页面\", \"个人设置-页面\"]', '启用', '2024-11-03 14:19:35', 'admin', '2024-11-03 14:19:44', 'admin', '超级管理员角色');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('admin', '超级管理员', '240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9', '启用', '未知', '[\"super_admin\"]', '{}', '', '', '', '2024-11-02 23:36:37', '', '2024-11-02 23:36:53', '初始超级管理员');
