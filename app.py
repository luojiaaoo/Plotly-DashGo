...
def valid_token():
    ...
    rt_access = util_jwt.jwt_decode_from_session(verify_exp=True, force_logout_if_exp=False) # can not force logout, because global_reload component do not exists
