...
<p align="center">
    ...
    <a href="https://gitee.com/luojiaaoo/DashGo"><img src="https://img.shields.io/badge/DashGo-v1.1.3-brightgreen.svg"></a>
...
8. 任务模块支持数据抽取与个性化信息推送，支持`Server酱`、`企业微信群机器人`、`SMTP邮件`，可以实现数据大屏、实时监控和通知推送
...
3. 符合主流数据平台风格
4. 丰富的消息通知渠道：`Server酱`、`企业微信群机器人`、`SMTP邮件`
