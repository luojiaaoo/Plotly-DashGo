...
print(jwt_encode({'a':'a'},expires_delta=False))
a = jwt_decode('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhIjoiYSJ9.aXkn6ErbuMt5-Ebtno2-WlBPHaR-bHKT3x2lX_30B_o',verify_exp=True)
print(a)